  ...
  .ForMember(x => x.ServiceCategoryName, vm => vm.MapFrom(vmf => vmf.ServiceCategoryName));
            ...
            CreateMap<TransactionDetailDTO, TransactionDetailViewModel>()
                .ForMember(x => x.Price, vm => vm.MapFrom(
                    vmf => vmf.InvoiceNumber != null && vmf.InvoiceNumber.Contains(Common.Enums.TransactionType.Sales.ToString().Substring(0, 3)) ? vmf.FinalSalePrice : vmf.PurchasePrice));
            ...
            CreateMap<TransactionDetailReportDTO, ListTransactionDetailReportViewModel>()
                 ...
                 vmf.TransactionCode == Common.Enums.TransactionType.Sales.ToString() ? string.Format(new CultureInfo("hi-IN"), "{0:c}", (vmf.Price)) :
                 ...
                 vm => vm.MapFrom(vmf =>
                 vmf.TransactionCode == Common.Enums.TransactionType.Sales.ToString() ? string.Format(new CultureInfo("hi-IN"), "{0:c}", (vmf.Price * vmf.Amount)) :
            ...
            CreateMap<TransactionDetail, TransactionDetailDTO>()
                ...
                vmf.Transaction.InvoiceNumber.Contains(Common.Enums.TransactionType.Sales.ToString().Substring(0, 3)) ? string.Format(new CultureInfo("hi-IN"), "{0:c}", vmf.FinalSalePrice) :
                string.Format(new CultureInfo("hi-IN"), "{0:c}", vmf.Product.PurchasePrice))))
                .ForMember(dm => dm.SubTotalPrice, vm => vm.MapFrom(vmf =>
                (vmf.Transaction.InvoiceNumber != null && vmf.Transaction.InvoiceNumber.Contains(Common.Enums.TransactionType.Sales.ToString().Substring(0, 3)) ? string.Format(new CultureInfo("hi-IN"), "{0:c}", (vmf.FinalSalePrice * (100 / (100 + vmf.Product.Tax.Rate)) * vmf.Amount)) :
            ...
            CreateMap<TransactionDetail, TransactionDetailReportDTO>()
                 ...
                 vm.MapFrom(vmf => vmf.Transaction.InvoiceNumber.Contains(Common.Enums.TransactionType.Sales.ToString().Substring(0, 3)) ? vmf.FinalSalePrice : vmf.Product.PurchasePrice))
                 .ForMember(dm => dm.PurchasePrice, vm => vm.MapFrom(vmf => vmf.Product.PurchasePrice != null ? vmf.Product.PurchasePrice.ToString() : null))
