    ...
    public class MapProfile : Profile
    {
        public MapProfile()
        {
            ...
            CreateMap<StoreDTO, ListStoreViewModel>()
                 .ForMember(dm => dm.ImageDisplay, vm => vm.MapFrom(vmf => !string.IsNullOrEmpty(vmf.Image) ? "store/" + vmf.Image : "/dist/img/no-user-image.png"));
            ;
            ...
            CreateMap<TransactionDetail, TransactionDetailReportDTO>()
                 ...
                 .ForMember(dm => dm.Price, vm => vm.MapFrom(vmf => vmf.Product.SalePrice.ToString()))
                 .ForMember(dm => dm.PurchasePrice, vm => vm.MapFrom(vmf => vmf.Product.PurchasePrice.ToString()))
                 .ForMember(dm => dm.TotalPrice, vm => vm.MapFrom(vmf => (vmf.Product.SalePrice * vmf.Amount).ToString()))
