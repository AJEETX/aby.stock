$(document).ready(function () {
    var datatable = $('#datatable').dataTable({
        ...
        "processing": true,
        "paging": true,
        "sAjaxSource": "/ExpenseCategory/List",
        "info": true,
            ...
            [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        var buttons = "";
                        buttons += '<a href="/ExpenseCategory/Edit/' + row.Id + '" class="btn btn-xs btn-warning"><i class="fas fa-pen"></i> Edit</a>&nbsp;'
