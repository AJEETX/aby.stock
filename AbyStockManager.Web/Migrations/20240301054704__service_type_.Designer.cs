...
namespace AbyStockManager.Web.Migrations
{
    ...
    [Migration("20240301054704__service_type_")]
    partial class _service_type_
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3272)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "4 wheeler",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3275)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Heavy Vehicle",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3278)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Tractor",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3281)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3284)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3591)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Rent",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3600)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Travel",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3603)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Utilities",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3606)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Water",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3608)
                        },
                        new
                        {
                            Id = 6,
                            CategoryName = "Wage",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3611)
                        },
                        new
                        {
                            Id = 7,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3613)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(5679),
                            ServiceCategoryName = "WHEEL-ALIGNMENT"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(5685),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(5551),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Tax", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3746),
                            Name = "FIRST",
                            Rate = 18.0
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3751),
                            Name = "SECOND",
                            Rate = 28.0
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(2765),
                            TransactionTypeName = "Stock In"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(2828),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3128),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3145),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(3152),
                            Isocode = "m",
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 3, 1, 16, 47, 4, 303, DateTimeKind.Local).AddTicks(5283),
                            Email = "jag@sda.com",
                            Name = "Jagdeesh Kumar",
