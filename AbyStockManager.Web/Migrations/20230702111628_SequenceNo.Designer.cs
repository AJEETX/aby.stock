...
namespace AbyStockManager.Web.Migrations
{
    ...
    [Migration("20230702111628_SequenceNo")]
    partial class SequenceNo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3960)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "4 wheeler",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3964)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Heavy Vehicle",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3967)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Tractor",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3969)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3972)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4377)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Rent",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4388)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Travel",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4393)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Utilities",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4397)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Water",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4402)
                        },
                        new
                        {
                            Id = 6,
                            CategoryName = "Wage",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4406)
                        },
                        new
                        {
                            Id = 7,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4410)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(5776),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Tax", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4679),
                            Name = "FIRST",
                            Rate = 18.0
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(4685),
                            Name = "SECOND",
                            Rate = 28.0
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3349),
                            TransactionTypeName = "Stock In"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3423),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3834),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3850),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(3857),
                            Isocode = "m",
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(5463),
                            Email = "jag@sda.com",
                            Name = "Jagdeesh",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 21, 16, 28, 161, DateTimeKind.Local).AddTicks(5579),
                            Email = "sarb@sda.com",
                            Name = "Sarbjeet",
