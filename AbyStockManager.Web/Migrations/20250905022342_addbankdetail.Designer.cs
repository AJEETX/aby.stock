...
namespace AbyStockManager.Web.Migrations
{
    ...
    [Migration("20250905022342_addbankdetail")]
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3186)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "4 wheeler",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3187)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Heavy Vehicle",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3189)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Tractor",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3190)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3192)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3578)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Rent",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3580)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Travel",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3582)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Utilities",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3583)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Water",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3585)
                        },
                        new
                        {
                            Id = 6,
                            CategoryName = "Wage",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3586)
                        },
                        new
                        {
                            Id = 7,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3587)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ServiceCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(5862),
                            ServiceCategoryName = "WHEEL-ALIGNMENT"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(5863),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(5757),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Tax", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3722),
                            Name = "FIRST",
                            Rate = 18.0
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3724),
                            Name = "SECOND",
                            Rate = 28.0
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(2671),
                            TransactionTypeName = "Stock In"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(2687),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3066),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3072),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(3077),
                            Isocode = "m",
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 9, 5, 7, 53, 42, 597, DateTimeKind.Local).AddTicks(5528),
                            Email = "jag@sda.com",
                            Name = "Jagdeesh Kumar",
