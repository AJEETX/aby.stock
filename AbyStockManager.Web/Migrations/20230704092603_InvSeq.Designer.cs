...
namespace AbyStockManager.Web.Migrations
{
    ...
    [Migration("20230704092603_InvSeq")]
    partial class InvSeq
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9716)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "4 wheeler",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9718)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Heavy Vehicle",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9721)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Tractor",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9722)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9724)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9923)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Rent",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9928)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Travel",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9930)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Utilities",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9931)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Water",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9933)
                        },
                        new
                        {
                            Id = 6,
                            CategoryName = "Wage",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9935)
                        },
                        new
                        {
                            Id = 7,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9936)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 822, DateTimeKind.Local).AddTicks(1437),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Tax", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 822, DateTimeKind.Local).AddTicks(16),
                            Name = "FIRST",
                            Rate = 18.0
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 822, DateTimeKind.Local).AddTicks(19),
                            Name = "SECOND",
                            Rate = 28.0
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9411),
                            TransactionTypeName = "Stock In"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9474),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9648),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9653),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 821, DateTimeKind.Local).AddTicks(9657),
                            Isocode = "m",
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 4, 19, 26, 3, 822, DateTimeKind.Local).AddTicks(1313),
                            Email = "jag@sda.com",
                            Name = "Jagdeesh Kumar",
