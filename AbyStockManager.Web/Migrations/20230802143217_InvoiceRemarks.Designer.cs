...
namespace AbyStockManager.Web.Migrations
{
    ...
    [Migration("20230802143217_InvoiceRemarks")]
    partial class InvoiceRemarks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4598)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "4 wheeler",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4600)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Heavy Vehicle",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4602)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Tractor",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4603)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4604)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Snacks",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4787)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Rent",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4790)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Travel",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4792)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Utilities",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4793)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Water",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4795)
                        },
                        new
                        {
                            Id = 6,
                            CategoryName = "Wage",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4796)
                        },
                        new
                        {
                            Id = 7,
                            CategoryName = "Other",
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4798)
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(6097),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.Tax", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4869),
                            Name = "FIRST",
                            Rate = 18.0
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4871),
                            Name = "SECOND",
                            Rate = 28.0
                        });
                });
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4315),
                            TransactionTypeName = "Stock In"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4360),
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4522),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4531),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(4536),
                            Isocode = "m",
            ...
            modelBuilder.Entity("Aby.StockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 8, 3, 0, 32, 17, 346, DateTimeKind.Local).AddTicks(5824),
                            Email = "jag@sda.com",
                            Name = "Jagdeesh Kumar",
